...
Appleは，2016年10月24日（16B2555）に続き，2016年10月27日（16B2557）にもmacOS 10.12.1をリリースしました。4D v15.3は，初めにリリースされたほうのバージョン（16B2555）で互換性検証に合格し，macOS 10.12 Sierraに対応しました。ところが，27日にリリースされたほうのバージョン（16B2557）では，クラッシュなどの深刻な不具合が起きるようになりました。__4D v15.3が正式に対応しているのは，2016年10月24日（16B2555）にリリースされたmacOS 10.12.1です__。なお，24日のmacOSのアップデートを済ませたユーザーは，27日版のアップデートが通知されません。したがって4D v15.3で不具合が発生する27日版のmacOS 10.12.1を使用しているユーザーは限られていると思われます。

**参考**：[Mac で macOS のバージョン番号を調べる](https://support.apple.com/ja-jp/HT201260)

**ヒント**：バージョン番号をクリックすると、ビルド番号が表示されます。

開発者向けに公開されているmacOS 10.12.2のベータ版では，かなりの改善がみられており，4Dでは，引き続きmacOSの修正に期待したいと考えています。同時に，macOS 10.12.2が正式にリリースされるまでは，互換性の検証を待つことにしました。Macユーザーの皆様には，ご不便をおかけいたしますが，事情をご理解いただければ幸いです。
